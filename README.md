...
- [Helium Market Resolution Benchmark](https://huggingface.co/datasets/HeliumTrades/helium-market-resolution-benchmark) - 300 frozen option-chain questions across six tickers; tests IV, delta, arbitrage, and rich-vs-average strike with ground truth from live chains. [Overview](https://heliumtrades.com/benchmarks/)
