...
- [BDE Score™](https://github.com/hbhqq9/bde-score) - Multi-factor stock scoring MCP server for US/HK/A-share markets. Provides transparent value, growth, quality, momentum, and sentiment scores via MCP protocol. EU AI Act Art.50 compliant with $0.01/query x402 micropayments.
